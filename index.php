...
<body>
    ...
    <main class="main">
        <section class="presentation">
            <img class="logo" src="img/logo.png" alt="EdSide">
        ...
        <section class="info-calendar">
            <img class="section-img"  src="tmp/calendrier.PNG" alt="calendar">
        ...
        <section class="info-simulator">
            ...
            <img class="section-img" src="tmp/simulator.PNG" alt="simulator">
        </section>
        <section class="info-tutoring">
            <img class="section-img" src="tmp/parrainage.PNG" alt="tutoring">
            <div class="section-text">
